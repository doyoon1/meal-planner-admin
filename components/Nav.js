      ...
      return (
        <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 pr-2 fixed w-full bg-background h-full md:static md:w-auto transition-all"}>
            ...
            <nav className="flex flex-col gap-4">
                ...
                <Link href={'/sessions'} className={pathname.includes('/sessions') ? activeLink : inactiveLink}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={pathname === '/sessions' ? activeIcon : inactiveIcon}>
