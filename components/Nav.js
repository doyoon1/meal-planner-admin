      ...
      return (
        <aside className={(show?'left-0':'-left-full')+" top-0 text-gray-500 p-4 pr-2 fixed w-full bg-background h-full md:static md:w-auto transition-all fixed z-999 top-0 left-0"}>
            ...
            <nav className="flex flex-col gap-4">
                ...
                <Link href={'/inquiries'} className={pathname.includes('/inquiries') ? activeLink : inactiveLink}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={pathname === '/inquiries' ? activeIcon : inactiveIcon}>
